...
class Example extends React.Component {
  ...
  // React components have sfeveral "lifecycle functions"
    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          <p>The motto of {this.state.name} is: {this.state.motto}</p>
          <p>But, below, you can change the motto to whatever you like.</p>
          <div className="cs142-example-output">
            <label htmlFor="inId">Choose the motto:</label>
            <input id="inId" type="text" value={this.state.motto} onChange={(e) => this.setState({ motto: e.target.value })} />
          </div>
        </div>
